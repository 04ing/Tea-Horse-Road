...
- **map.html**：地图分析页面，提供茶马古道的空间分析和历史地图展示
...
- **文本更新**：在map.html中将"村落"改为"居民点"
- **样式调整**：修改了"居民点分布概览"中图层说明四个按钮的字体大小，使其在同一行展示
...
### 2026-02-23
- **视频文件路径优化**：创建了专门的video目录存放视频文件
- **文件结构调整**：修改了所有HTML文件中的视频引用路径，统一指向video目录
- **代码清理**：更新了README.md中的项目结构说明，反映最新的文件组织
